...
**Prove plugin v1.0.1** — if the installed plugin version (`cat /Users/manuelmorales/dev/claude-prove/.claude-plugin/plugin.json | grep version`) does not match v1.0.1, run `/prove:update` to sync.
