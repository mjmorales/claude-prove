...
<!-- prove:plugin-version:3.9.0 -->
**Prove plugin v3.9.0** — if `bun run "${CLAUDE_PROVE_PLUGIN_DIR:-$HOME/.claude/plugins/prove}/packages/cli/bin/run.ts" --version` does not match v3.9.0, run `/prove:update` to sync.
