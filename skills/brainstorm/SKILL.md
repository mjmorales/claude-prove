...
When the user asks to commit decision records or other brainstorm artifacts, delegate to the `commit` skill. Do not create ad-hoc commits. The commit skill reads `MANIFEST` for valid scopes and uses conventional commit format.
