...
### `/prove:steward --auto` -- Iterative Audit-Fix Loop
...
| Want hands-off cleanup with convergence guarantee | `/prove:steward --auto` |
| Several agent tasks have accumulated | `/prove:steward --auto` |
